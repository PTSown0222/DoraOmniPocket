"""Scripts: Download Dataset from Third Party like Huggingface or Kaggle"""
import os
import argparse
import requests
...
def download_file(url: str, file_name: str):
    ...
    """
    try:
        log.info(f"Download data from {url} and file name {file_name}")
        ...
        log.error(f"Cannot Download Data from {e}")
